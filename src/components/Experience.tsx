  ...
  return (
    <section id="experience" className="w-full py-20" style={{ background: "linear-gradient(to bottom, #000, #0a1a0f)" }}>
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-xs tracking-widest uppercase text-center mb-3" style={{ color: "#c9a961" }}>The Experience</p>
        <h2 className="text-4xl md:text-5xl font-serif font-light text-center mb-3" style={{ color: "#b8b8b8" }}>
          Where Wilderness Meets
        </h2>
        <h2 className="text-4xl md:text-5xl font-serif font-light text-center mb-8" style={{ color: "#c9a961", fontStyle: "italic" }}>
          Refined Living
        </h2>
